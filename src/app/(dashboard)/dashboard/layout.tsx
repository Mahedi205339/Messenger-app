                        ...
                        <li>
                            ...
                            <ul role='list' className='-mx-2 space-y-1'>
                                {sidebarOptions.map((option) => {
                                    ...
                                    return (
                                        <li key={option.id}>
                                            <Link href={option.href} className='text-gray-700 hover:bg-gray-50 group flex gap-3 rounded-md p-2 text-sm leading-6 font-semibold'>
                        ...
                        <li className='-mx-6 flex items-center'>
                            <div className='flex flex-1 items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-gray-900'>
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <span aria-hidden className='text-xs text-zinc-400' >{session.user.email} </span>
                                </div>
                            </div>
                        </li>
                    </ul>
